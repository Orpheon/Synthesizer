...
The previous approach worked fine for sine waves, but in both other waveforms there is a recurring discontinuity. In the frequency range, this translates to an infinite frequency, inducing aliasing, as the Nyquist frequency cannot be infinite.
...
This method turns out to be rather complex, and quickly became a problem to implement. So I searched for simpler methods with less book-keeping involved, and once I had found one I gave up on this particular implementation.
